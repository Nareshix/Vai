...
'''
import re
prefix = '/Vai'  # change this to your desired prefix

# Regex: capture fetch('  +  match the starting slash + search_index.json  + closing '
pattern = r"(fetch\(\s*')[/]search_index\.json(')"
replacement = r"\1" + prefix + r"/search_index.json\2"

modified_js = re.sub(pattern, replacement, js)
print(modified_js)
